...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def from_url(cls, url, *, loop=None, stream=False):
        ...
        return cls(discord.FFmpegPCMAudio(filename, before_options='-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5 -vn'), data=data)
...
async def main():
    async with bot:
        ...
        await bot.start('MTA1OTA1NzkwNDc0MjgzMDA4MA.GsdzIq.fjMBDP8QvP5qjd-dJ85A0QiNoxOUdWLKv16Qec')
